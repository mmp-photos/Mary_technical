function About() {
  ...
  return (
    <div className="row section-container" id="about">
      <div className="col-md-5 col-md-offset-2">
        <h2>About Mary Beth</h2>
        <p>Mary Beth Karty is on a mission to eliminate ambiguity. Clear communication is her passion. She understands that "average" just won't do when the difference between median and mean can be the difference between life and death.</p>
        <p>Mary Beth writes with the precision of a Purdue-trained technical writer. She edits and provides feedback with the deft hand of someone who has spent years leading and submitting work to writer's groups.</p>
        <p>A thorough researcher Mary Beth prides herself both on the number of citations and the impeccible formatting of her footnotes.</p>
